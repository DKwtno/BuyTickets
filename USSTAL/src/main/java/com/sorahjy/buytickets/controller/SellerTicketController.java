...
public class SellerTicketController {
    ...
    private final Integer AIRLINETYPE=0;
    ...
    public ModelAndView list(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        Page<TicketInfo> ticketInfoPage = ticketInfoService.findUpAll(AIRLINETYPE,request);
    ...
    public ModelAndView save(@Valid TicketForm form, BindingResult bindingResult,
        ...
        if (bindingResult.hasErrors()) {
            ...
            map.put("url", "/usstal/seller/ticket/index");
        }
        ...
        map.put("url", "/usstal/seller/ticket/list");
    ...
    public ModelAndView newer (@Valid TicketForm form, BindingResult bindingResult,
        ...
        try {
            ...
            map.put("msg", e.getMessage());
            map.put("url", "/usstal/seller/ticket/add");
            return new ModelAndView("common/error", map);
